...
const projectsDetailData: Record<string, ProjectDetail> = {
    "mentorship-coaching-program": {
        ...
        heroImage: "https://cdn.prod.website-files.com/635673d6c8505112db680f36/6891fe5f4b0df4907fec586f_IMG-20250805-WA0051-p-1080.jpg",
        summary: "A transformative mentorship and coaching initiative launched in Q1 2025 to empower entrepreneurs with practical guidance, business skills, and growth opportunities.",
        fullDescription: `The Mentorship and Coaching Program was designed to bridge the gap between early-stage ideas and sustainable businesses. Over 12 weeks, participants received one‑on‑one mentoring from industry veterans, attended workshops on financial literacy and business modeling, and built peer networks that continue to support them.

The program culminated in a Demo Day where five outstanding ventures pitched to impact investors, with two receiving follow‑on funding. Participants reported increased confidence, clearer business strategies, and tangible growth metrics.`,
        impactStats: [
    ...
    "circular-table": {
        ...
        date: "2024",
        location: "Nairobi, Kenya",
        heroImage: "https://cdn.prod.website-files.com/635673d6c8505112db680f36/688e336892aabedfae90fd89_Circular%20Table%203-p-800.jpg",
        summary: "The Circular Table connects entrepreneurs and innovators in waste management, circular economy and sustainability.",
...
The 2024 edition attracted over 150 attendees, facilitated 30+ B2B connections, and sparked three collaborative projects that are now being incubated.`,
        impactStats: [
        ...
        keyHighlights: [
            "Keynote from leading circular economy expert Dr. Jane Nduta",
            "Pitch session for 10 early‑stage waste innovators",
            "Live circular design workshop",
        ],
        partners: [
            { name: "WasteSense Africa" },
            { name: "EcoPost Kenya" },
        ],
    },
    "grant-writing-workshop": {
        ...
        heroImage: "https://cdn.prod.website-files.com/635673d6c8505112db680f36/688e333c92b89e39c3c434d1_Grant%20Application%202-p-1080.jpg",
...
Post‑workshop surveys showed that 80% of attendees felt more confident in applying for grants, and six organisations have since secured grants or contracts using the tools provided.`,
        ...
        keyHighlights: [
            ...
            "One‑on‑one office hours with grant reviewers",
        ],
        partners: [
            { name: "Kenya Climate Innovation Centre" },
            { name: "GS1 Kenya" },
    ...
    "barcode-training-program": {
        ...
        date: "2024",
        location: "Nairobi, Kenya",
        heroImage: "https://cdn.prod.website-files.com/635673d6c8505112db680f36/688e334c8666671121420e8a_Barcode%20Training%20Program-p-800.jpg",
...
Over 40 entrepreneurs from agribusiness, manufacturing, and retail sectors participated. Eight businesses have since registered for GS1 barcodes and are now selling through major supermarket chains.`,
        impactStats: [
            ...
            { label: "Market Access Gained", value: "8 businesses", icon: ArrowRight },
        ],
        keyHighlights: [
        ...
        return (
            <div className="min-h-screen bg-white flex items-center justify-center">
                <div className="text-center max-w-md px-4">
                    ...
                    <p className="text-gray-600 mb-6">Sorry, we couldn't find the project you're looking for.</p>
                    <Link
                        to="/projects"
        ...
        <div className="min-h-screen bg-white overflow-x-hidden">
            ...
            <div className="pt-28 lg:pt-32 border-b border-gray-100">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center gap-2 text-sm text-gray-400">
                    <Link to="/projects" className="hover:text-[#3d7118] transition-colors inline-flex items-center gap-1.5">
                    ...
                    <div className="grid grid-cols-3 divide-x divide-gray-100 border border-gray-100 rounded-2xl overflow-hidden mb-10">
                        {project.impactStats.map((stat, idx) => (
                            <div key={idx} className="px-6 py-5 bg-gray-50/60">
                                <p className="text-2xl md:text-3xl font-bold text-[#3d7118]">{stat.value}</p>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {project.fullDescription.split('\n\n').map((para, idx) => (
                                    <p key={idx} className="text-gray-600 leading-[1.8] text-[15px]">
                                        {para.trim()}
                                    </p>
                                ))}
                            </div>
                    ...
                    <aside className="space-y-5 lg:sticky lg:top-28 self-start">
                        ...
                        <div className="rounded-2xl border border-gray-100 divide-y divide-gray-100 overflow-hidden">
                            ...
                            {project.location && (
                                <div className="px-5 py-4 flex items-center justify-between gap-4">
                                    <span className="text-xs text-gray-400 shrink-0">Location</span>
                                    <span className="text-sm font-semibold text-gray-800 text-right">{project.location}</span>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="rounded-2xl bg-[#0e1a06] p-6 text-white">
                            ...
                            <p className="text-sm text-white/55 leading-relaxed mb-5">
                                {project.nextSteps ?? "Partner with us to scale impact like this project."}
                            </p>
                            <Link
                                to="/contactUs"
