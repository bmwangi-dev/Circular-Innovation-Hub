...
const StartupHubPage = () => {
  ...
  const resources = [
    {
      ...
      description:
        "Templates, guides, and resources to help you build your startup",
    ...
    },
    {
      ...
      description: "Access to grants, investors, and funding programs",
      color: "from-[#3d7118] to-[#3d7118]",
    },
    {
      icon: Calendar,
      title: "Workshops & Events",
      description: "Regular training sessions and networking events",
      color: "from-[#3d7118] to-[#3d7118]",
    },
  ];
  ...
  const upcomingEvents = [
    ...
    {
      title: "Circular Economy Bootcamp",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight animate-slide-up mb-6">
              Your <span className="gradient-text">Startup Journey</span> Starts
              Here
            </h1>
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed animate-slide-up delay-100 max-w-2xl mx-auto">
              Join a vibrant community of circular economy entrepreneurs. Access
              resources, mentorship, and funding to scale your impact.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Building{" "}
              <span className="gradient-text">Sustainable Ventures</span>
            </h2>
            <div className="w-24 h-1 bg-gradient-to-r from-[#3d7118] via-[#3d7118] to-[#e1ac00] rounded-full mx-auto"></div>
            <p className="text-gray-600 mt-6 max-w-3xl mx-auto">
              We empower startups with the tools, connections, and knowledge
              they need to thrive in the circular economy.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center hover-lift">
              ...
              <p className="text-gray-600 leading-relaxed">
                Connect with like-minded founders, investors, and industry
                experts.
              </p>
              <div className="mt-6 pt-4 border-t border-gray-100">
                <span className="text-sm text-[#3d7118] font-medium">
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center hover-lift">
              ...
              <p className="text-gray-600 leading-relaxed">
                Access cutting-edge tools and methodologies to build disruptive
                solutions.
              </p>
              <div className="mt-6 pt-4 border-t border-gray-100">
                <span className="text-sm text-[#e1ac00] font-medium">
                  150+ innovations launched
                </span>
              </div>
            </div>
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center hover-lift">
              ...
              <p className="text-gray-600 leading-relaxed">
                Build sustainable business models that create lasting impact and
                returns.
              </p>
              <div className="mt-6 pt-4 border-t border-gray-100">
                <span className="text-sm text-[#3d7118] font-medium">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-in-left">
              ...
              <p className="text-gray-600 mb-6">
                Our accelerator program walks with you from idea generation to
                scale-up, connecting you with mentors, partners, opportunities,
                and investors.
              </p>
              <div className="space-y-4">
                {[
                  {
                    icon: UserCheck,
                    text: "Identify youth and women-owned businesses in our thematic areas",
                    color: "from-[#3d7118] to-[#3d7118]",
                  },
                  {
                    icon: FileText,
                    text: "Research and showcase new technologies through trainings and webinars",
                    color: "from-[#e1ac00] to-[#e1ac00]",
                  },
                  {
                    icon: Users,
                    text: "Conduct outreach workshops on circular principles for innovators",
                    color: "from-[#3d7118] to-[#3d7118]",
                  },
                ].map((item, idx) => (
                  <div
                    key={idx}
                    className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl hover:bg-gradient-to-r hover:from-green-50 hover:to-yellow-50 transition-all duration-300 group"
                  >
                    <div
                      className={`w-10 h-10 bg-gradient-to-br ${item.color} rounded-xl flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform`}
                    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 mt-6 max-w-2xl mx-auto">
              Everything you need to build, grow, and scale your circular
              economy startup
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {resources.map((resource, idx) => (
              <div
                key={idx}
                className="group bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover-lift transition-all text-center"
              >
                <div
                  className={`w-16 h-16 mx-auto bg-gradient-to-br ${resource.color} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 to-[#3d7118]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-[#e1ac00] mb-2">600</div>
              <p className="text-green-200">Trainings</p>
            </div>
            <div>
            ...
            <div>
              <div className="text-4xl font-bold text-[#e1ac00] mb-2">
                $2.5M+
              </div>
